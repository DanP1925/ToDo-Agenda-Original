<%-- 
    ...
    Created on : 29/02/2016, 10:58:09 PM
    Author     : Daniel
--%>
...
<html>
    ...
    <body id ="monthlyBody">
        <div id = "dailyHeader">
            <div id = "dailyLogOutWelcome">
                ...
                <div id="welcomeMessage">
                    <h2><%= welcomeMessage%> Monthly View</h2>
        ...
        <div id="monthlyBodyGroup">
            <div id="dailyViewButtons">
                <form id="monthlyView" action="Controller" method="GET" enctype="text/plain">
                    <input class="myButton" type="submit" name="action" value="Daily View" />
                    <button class="myButton" type ="button">Monthly View</button>
                </form>
            </div>
            ...
            <div id="calendar">
                <script language="javascript" type="text/javascript">
                    ...
                    cal += '<TABLE id="calendarTable" BORDER=0 CELLSPACING=0 CELLPADDING=2>' + TR_start;
            ...
            <div id="mostImportantTask">
                <h2>The most important task for today is:</h2>
                <jsp:useBean id="currentTask" type="todoClasses.Task" scope="request" />
                <%if (currentTask.getTitle() != null) {%>
                <label> Title :</label>
                <h4><jsp:getProperty name="currentTask" property="title"/></h4>
                <label> Description :</label>
                <h4 id="mostImportantDescription"><jsp:getProperty name="currentTask" property="description"/></h4>
                <%if (currentTask.getDeadline() != null) {%>
                <label>Deadline(YYYY-MM-DD):</label>
                <h4><jsp:getProperty name="currentTask" property="deadline"/></h4>
                <%}%>
                <%} else {%>
                <h3>There weren't task to do for today</h3>
                <%}%>
            </div>
        </div>
    </body>
